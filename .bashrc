# ~/configs/.bashrc: executed by bash(1) for non-login shells.
...
# eval "$(oh-my-posh init bash --config ~/.poshthemes/capr4n.omp.json)"
...
# eval "$(oh-my-posh init bash --config ~/.poshthemes/cloud-context.omp.json)"
